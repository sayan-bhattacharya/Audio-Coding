...
class signals():
    ...
    def calculateSTFT(self, signal):
        ...
        sample_frequency, segment_time, zxx = sc.stft(signal, self.sampling_freq, nperseg= 2 * self.dft_resolution)
    ...
    def mappingFreqToBarkDomain(self, quantized_Bark):
        ...
        barkFreqMapMat = np.zeros((self.bark_resolution, self.dft_resolution + 1))
